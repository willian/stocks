  ...
  return (
    <>
      ...
      <div className="flex flex-col min-h-screen font-sans text-base antialiased select-none bg-cool-gray-200">
        <div
          className="box-border relative flex flex-col flex-1 w-full mx-auto text-gray-800 bg-gray-50 dark:bg-gray-900"
        >
          <header
            className="box-border fixed z-10 flex items-end w-full shadow-sm bg-gradient-to-r from-purple-900 to-purple-600 h-11"
          >
            <div
            ...
            >
              <Link href="/">
                <a className="text-lg font-semibold leading-none text-white">
                  Stocks
                </a>
              </Link>
